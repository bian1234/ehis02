...
<body>
	<ul class="nav nav-tabs">
		<li><a
			href="${ctx}/sys/prescriptionOffice/list?id=${office.parent.id}&parentIds=${office.parentIds}">机构列表</a></li>
		<li class="active"><a
			href="${ctx}/sys/prescriptionOffice/form?id=${office.id}&parent.id=${office.parent.id}">机构<shiro:hasPermission
	...
	<br />
	<form:form id="inputForm" modelAttribute="prescriptionOffice"
		action="${ctx}/sys/prescriptionOffice/save" method="post"
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="office" name="parent.id"
					value="${prescriptionOffice.parent.id}" labelName="parent.name"
					labelValue="${prescriptionOffice.parent.name}" title="机构"
					url="/sys/prescriptionOffice/treeData" extId="${office.id}"
					cssClass="" allowClear="${office.currentUser.admin}" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">归属区域:</label>
			<div class="controls">
				<sys:treeselect id="area" name="area.id" value="${prescriptionOffice.area.id}"
					labelName="area.name" labelValue="${prescriptionOffice.area.name}" title="区域"
					url="/sys/prescriptionArea/treeData" cssClass="required" />
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="primaryPerson" name="primaryPerson.id"
					...
					url="/sys/prescriptionOffice/treeData?type=3" allowClear="true"
		...
		<%-- <div class="control-group">
			...
			<div class="controls">
				<form:input path="departmentName" htmlEscape="false" maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">部门编码:</label>
			<div class="controls">
				<form:input path="departmentCode" htmlEscape="false" maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">部门类型:</label>
			<div class="controls">
				<form:input path="departmentType" htmlEscape="false" maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">部门等级:</label>
			<div class="controls">
				<form:input path="departmentGrade" htmlEscape="false" maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">部门地址:</label>
			<div class="controls">
				<form:input path="departmentAddress" htmlEscape="false"
					maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="departmentMaster" htmlEscape="false"
					maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="departmentPhone" htmlEscape="false" maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">部门传真:</label>
			<div class="controls">
				<form:input path="departmentFax" htmlEscape="false" maxlength="50" />
			</div>
		</div> --%>
		<!-- 新加 end -->
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:prescriptionOffice:edit">
