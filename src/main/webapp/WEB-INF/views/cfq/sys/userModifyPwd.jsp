...
<%-- 		<li><a href="${ctx}/sys/prescriptionUser/info">个人信息</a></li>
 --%>		<li class="active"><a href="${ctx}/sys/prescriptionUser/modifyPwd">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="prescriptionUser" action="${ctx}/sys/prescriptionUser/modifyPwd" method="post" class="form-horizontal">
		<form:hidden path="id"/>
