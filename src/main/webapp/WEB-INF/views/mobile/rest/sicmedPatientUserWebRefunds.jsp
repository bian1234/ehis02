...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/web/useRefunds/sicmedPatient/">患者列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="sicmedPatient" action="${ctx}/web/useRefunds/sicmedPatient/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="sicmedPatient">
			<tr>
				...
				<td><a href="${ctx}/web/user/sicmedPatientPrice/patientPriceDetail?id=${sicmedPatient.id}&isPay=1">
