...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/web/sicmedStanderprescriptionAsked/">单表列表</a></li>
		<li class="active"><a href="${ctx}/web/sicmedStanderprescriptionAsked/form?id=${sicmedStanderprescriptionAsked.id}">单表<shiro:hasPermission name="web:sicmedStanderprescriptionAsked:edit">${not empty sicmedStanderprescriptionAsked.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="web:sicmedStanderprescriptionAsked:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sicmedStanderprescriptionAsked" action="${ctx}/web/sicmedStanderprescriptionAsked/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
