...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/rest/sicmedCase/">医嘱统计</a></li>
		<%-- <shiro:hasPermission name="rest:sicmedCase:edit"><li><a href="${ctx}/rest/sicmedCase/form">医嘱统计</a></li></shiro:hasPermission> --%>
	</ul>
	<form:form id="searchForm" modelAttribute="sicmedCase" action="${ctx}/rest/sicmedCase/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="sicmedCase">
			<tr>
				<td><a href="${ctx}/rest/sicmedCase/form?id=${sicmedCase.id}">
				...
				<shiro:hasPermission name="rest:sicmedCase:edit"><td>
    				<a href="${ctx}/rest/sicmedCase/form?id=${sicmedCase.id}">修改</a>
					<a href="${ctx}/rest/sicmedCase/delete?id=${sicmedCase.id}" onclick="return confirmx('确认要删除该保存成功吗？', this.href)">删除</a>
