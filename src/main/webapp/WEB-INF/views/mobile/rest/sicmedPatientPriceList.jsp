...
<body>
	...
	<form:form id="searchForm" modelAttribute="sicmedPatientPrice" action="${ctx}/web/sicmedPatientPrice/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>患者编号：</label>
				<form:input path="sicmedPatient.patientNumber" htmlEscape="false" maxlength="15" class="input-medium"/>
			</li>
		...
		<%-- 	<li><label>收费项目：</label> 
			...
			<%-- <sys:treeselect id="priceClassType"
					...
					title="父级编号" url="/web/sicmedPatientPrice/treeData" cssClass="" allowClear="true" /> --%>
				
				<select class="input-medium required" name="priceClassType">
				 	<c:choose>
				 		<c:when test="${sicmedPatientPrice.priceClassType == 0}">
				 			<option value="999">全部</option>
							<option selected="selected" value="0">检查</option>
							<option value="1">检验</option>
							<option value="2">治疗</option>
							<option value="3">药品</option>
							<option value="5">挂号</option>
       					</c:when>
       					<c:when test="${sicmedPatientPrice.priceClassType == 1}">
							<option value="999">全部</option>
							<option value="0">检查</option>
							<option selected="selected" value="1">检验</option>
							<option value="2">治疗</option>
							<option value="3">药品</option>
							<option value="5">挂号</option>
       					</c:when>
       					<c:when test="${sicmedPatientPrice.priceClassType == 2}">
							<option value="999">全部</option>
							<option value="0">检查</option>
							<option value="1">检验</option>
							<option selected="selected" value="2">治疗</option>
							<option value="3">药品</option>
							<option value="5">挂号</option>
       					</c:when>
       					<c:when test="${sicmedPatientPrice.priceClassType == 3}">
							<option value="999">全部</option>
							<option value="0">检查</option>
							<option value="1">检验</option>
							<option value="2">治疗</option>
							<option selected="selected" value="3">药品</option>
							<option value="5">挂号</option>
       					</c:when>
       					<c:when test="${sicmedPatientPrice.priceClassType == 5}">
							<option value="999">全部</option>
							<option value="0">检查</option>
							<option value="1">检验</option>
							<option value="2">治疗</option>
							<option value="3">药品</option>
							<option selected="selected" value="5">挂号</option>
       					</c:when>
       					<c:otherwise>
			...
			<li><label>收费状态：</label> 
				...
				<select class="input-medium required" name="isPay">
				 	<c:choose>
				 		<c:when test="${sicmedPatientPrice.isPay==0}">
				 			<option value="999">全部</option>
				 			<option value="0">未交费</option>
				 			<option value="1">缴费</option>
				 			<option value="2">退费</option>
				 		</c:when>
				 		<c:when test="${sicmedPatientPrice.isPay==1}">
				 			<option value="999">全部</option>
				 			<option value="0">未交费</option>
				 			<option value="1">缴费</option>
				 			<option value="2">退费</option>
				 		</c:when>
				 		<c:when test="${sicmedPatientPrice.isPay==2}">
				 			<option value="999">全部</option>
				 			<option value="0">未交费</option>
				 			<option value="1">缴费</option>
				 			<option value="2">退费</option>
			...
			<li><label style="font-size: 14PX; color: red">人数：${page.count}</label>
			</li>
