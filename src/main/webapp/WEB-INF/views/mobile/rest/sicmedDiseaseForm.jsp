...
<body>
	...
	<%-- 	<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:treeselect id="office"
					...
					title="疾病类别" url="/web/sicmedDisease/diseaseClass" extId="${diseaseClass.id}" cssClass="required" allowClear="true" />
				<font color="red">*</font> 
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="diseaseNameEnglish" htmlEscape="false" maxlength="20" class="input-xlarge"/>
			</div>
		</div>
		<div class="control-group">
