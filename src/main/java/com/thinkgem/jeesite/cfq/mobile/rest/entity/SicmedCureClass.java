 ...
 * @version 2016-07-23
 */
public class SicmedCureClass extends DataEntity<SicmedCureClass> {
    ...
    public SicmedCureClass() {
        super();
    }

    public SicmedCureClass(String id) {
        super(id);
    }
    ...
    @Length(min = 1, max = 30, message = "类别名称长度必须介于 0 和 30 之间")
